...
void load_resource() {
    ...
    JD_stop = al_load_bitmap("../res/image/JD_stop.tiff");
    ...
    load_sound("../res/sound/get_candy.mp3", &get_candy_sp, &get_candy_spi, ALLEGRO_PLAYMODE_ONCE);
    load_sound("../res/sound/lightning.mp3", &lightning_sp, &lightning_spi, ALLEGRO_PLAYMODE_ONCE);
    load_sound("../res/sound/Johnny_dead.mp3", &dead_sound_sp, &dead_sound_spi, ALLEGRO_PLAYMODE_ONCE);
    load_sound("../res/sound/Johnny_jump.mp3", &jump_sp, &jump_spi, ALLEGRO_PLAYMODE_ONCE);
}
